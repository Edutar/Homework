// task1
{
  const kilometres = +prompt(
    "Яку кількість кілометрів ти готовий бігати щодня?"
  );
  const wishtKilometres = +prompt(
    "Яку кількість усіх кілометрів ти хочеш пробігти за місяць?"
  );
  if (wishtKilometres <= kilometres) {
    alert("Ти зможеш пробігти усю заплановану дистанцію");
  } else {
    const difference = wishtKilometres - kilometres;
